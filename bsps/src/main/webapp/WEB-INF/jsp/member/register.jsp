	                            ...
	                            <div class="row">
	                                <div class="col-md-8" style="text-align: center;">
	                                    <div class="check-out_wrap fl-wrap">
	                                        <h4 class="cart-title" style="font-size:40px;color:#C19D60;"><hun>BIEUP CAFE <br>회원 가입</hun></h4>
	                                        <form class="custom-form" name="signupForm" id="signupForm" action="/member" method="POST" autocomplete="off">
	                                            <fieldset>
	                                                <div class="row">
			                                            ...
			                                            <div class="col-sm-8">
				                                            <div style="width:250px;">
		                                                       	<input type="text" name="emailAddress" id="emailAddress" placeholder="이메일을 입력하세요."
																	onfocus="this.placeholder=''" onblur="this.placeholder='이메일을 입력하세요.'" maxlength="200">
		                                                   	</div>
		                                                   	<div id="dupliblock">
		                                                        ...
		                                                        <input type="hidden" id="isDupli" value="true">
		                                                   	</div>
														...
														<div class="col-sm-8">
		                                                   	<div style="width:200px;">
		                                                       	<input type="password" class="password_input" id="password" name="password" placeholder="비밀번호를 입력하세요."
																	required="required" minlength="8" maxlength="30" oninput="confirm()" onchange="passwordCheck()" 
																	onfocus="this.placeholder=''" onblur="this.placeholder='비밀번호를 입력하세요.'">
		                                                   	</div>
		                                                   	<div style="width:200px;" id="confirmPasswordblock">
		                                                       	<input type="password" class="password_input" id="confirmPassword" placeholder="비밀번호를 재입력하세요."
																	required="required" minlength="8" maxlength="30" onchange="passwordCheck()"
																	onfocus="this.placeholder=''" onblur="this.placeholder='비밀번호를 재입력하세요.'">
		                                                   	</div>
		                                                   	<div><han id="checkPassword"></han></div>
	                                                   	</div>
	                                                   	<!-- 비밀번호 설정 끝 --> 
	                                                   	<!-- 전화번호 설정 구간 -->
	                                                    <div id="phone_service" class="phone_service">
		                                                    ...
		                                                    <div class="col-sm-6">
		                                                        <input type="text" id="phoneNo" name="phoneNo" placeholder="전화번호를 입력하세요." minlength="13" maxlength="13" required="required"
	                                                    ...
	                                                    <div id="address_service">
	                                                    	<div class="col-sm-12">
	                                                        	...
	                                                        	<button class="btn color-bg" type="button" onclick="searchZipcode()">
	                                                        	<hun>주소 검색</hun><i class="fal fa-long-arrow-right"></i></button></h4>
	                                                    	</div>
															<div>
																<div>
																	<div class="col-sm-6" style="width:150px;">
																		<input type="text" id="zipCode" name="zipCode" placeholder="우편번호" required="required"
																	...
																	<div class="col-sm-6" style="width:650px;">
																		<input type="text" id="detailAddress" name="detailAddress" placeholder="상세주소를 입력하세요."
																		 	required="required" maxlength="250" onfocus="this.placeholder=''"
	                                                ...
	                                                <button type="submit" class="btn color-bg"><hun>회원가입</hun><i class="fal fa-long-arrow-right"></i></button>
        ...
        <script>
			...
			function passwordCheck() {
				...
				if (document.getElementById('password').value != '' && document.getElementById('confirmPassword').value != '') {
					if (document.getElementById('password').value == document.getElementById('confirmPassword').value) {
						document.getElementById('checkPassword').innerHTML = '<h4>비밀번호가 일치합니다.</h4><br>';
						document.getElementById('checkPassword').style.color = 'white';
					}
					else {
						document.getElementById('checkPassword').innerHTML = '<h4>비밀번호가 맞지않습니다.</h4><br>';
		    ...
		    function initLayerPosition(){
		 	...
		 	signupForm.addEventListener('submit', function(event) {
		 		if (document.getElementById('isDupli').value === "true") {
		 			...
		 			alert('회원가입이 완료되었습니다.\n'
							+ '지금바로 Bieup Cafe의 다양한 혜택을 누려보세요.');
		 			return true;
		 		}
		  	});
		 	// 폼 submit 서비스 종료 -----------------------
